...
/// </summary>
public static class MaybeValueOrExtensions
{
    /// <summary>
    ...
    public static V ValueOr<V>(this Option<V> option, V alternative) => option.HasValue
        ? option.Value
        : alternative;
    ...
    public static V ValueOr<V>(this Option<V> option, Func<V> alternativeFactory)
    {
    ...
    /// <exception cref="ArgumentNullException">Thrown if the option or alternativeFactory is null.</exception>
    public static V ValueOr<V>(this Option<V> option, Func<string, V> alternativeFactory)
    {
        if (alternativeFactory == null)
            throw new ArgumentNullException(nameof(alternativeFactory));
