...
/// Option provided.
/// </summary>
public static class MaybeElseExtensions
{
    /// <summary>
    ...
    public static Option<V> Else<V>(this Option<V> option, Option<V> alternativeOption) =>
        option.HasValue
        ? option
        : alternativeOption;
    ...
    public static Option<V> Else<V>(this Option<V> option, Func<Option<V>> alternativeOptionFactory)
    {
