...
public static class MapExtensions
{
    ...
    /// <summary>
    /// Transforms the contained value of an Option&lt;V, F&gt; to Option&lt;T, F&gt; using a specified mapping function
    /// if the Option is in a successful state. This variant of Map allows for transformations to a different
    /// type of Option without changing the failure type. If the original Option is in a failed state, the failure is
